export default function OnRamp() {
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="bg-gradient-to-r from-royal-50 to-accent-50 p-8 rounded-xl text-center">
        ...
        <p className="text-gray-700 mb-6">
          We're integrating with Bridge, Coinbase Onramp, Yellow Card, and Transak to bring you the best on-ramp experience. Sign up for early access!
        </p>
      ...
      <div className="mt-12 bg-blue-50 border border-blue-200 rounded-xl p-6">
        ...
        <ol className="mt-3 space-y-1 text-sm text-gray-700 ml-4 list-decimal">
          <li>Visit <a href="https://faucet.circle.com/" target="_blank" rel="noopener" className="text-blue-600 underline">faucet.circle.com</a></li>
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-4">Fiat On-Ramp</h1>
      <p className="text-gray-600">Coming soon! Convert NGN, KES, GHS, ZAR to USDC.</p>
    </div>
  )
}
